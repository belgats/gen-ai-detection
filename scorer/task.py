...
def evaluate(pred_labels, gold_labels):
    """
        ...
        Metrics are:  macro_f1 and micro_f1
    ...
    precision = precision_score(gold_values, pred_values, average='macro')
    recall = recall_score(gold_values, pred_values, average='macro')
